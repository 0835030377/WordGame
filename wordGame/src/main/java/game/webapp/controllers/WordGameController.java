...
@Controller
public class WordGameController extends BaseController {
	private final static String GHOST_NAME = "ghost";
	private static final Logger LOG = Logger.getLogger(WordGameController.class);

	@Autowired
	private WordgamesService ghostService;
